   ...
   <div class="container-fluid p-0">
    ...
    <div class="bg-white secondpadding-admin">
        <a href="index.php" class="text-decoration-none"><h4 class="text-dark p-5 back-btn"><i class="fa-solid fa-arrow-left fa-lg me-2"></i>Back</h4>
            ...
            <h2 class="text-center p-2">View Payment</h2>
    </div>
            ...
            <div class="container text-center p-5">
                <table class="table table-hover table-striped text_center">
                    <thead class="table-dark">
                        ...
                        <th scope="col">Booking Price (RM)</th>
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT *, booking.cust_id FROM payment INNER JOIN booking ON payment.bookingid=booking.bookingid";
                        ...
                        while($row = mysqli_fetch_assoc($result)){
                            ...
                            <tr>
                                ...
                                <td><img src='../payment_proof/<?php echo $row['paymentproof'] ?>' class='img-fluid rounded-start' alt='...'></td>
                                <td><?php echo $row['paymentmethod'] ?></td>
                                <td><?php echo $row['paymentstatus'] ?></td>
                                <td>
                                    <a href="editpayment.php?id=<?php echo $row['paymentid']?>" class="link-dark"><i class="fa-solid fa-pen-to-square fs-5"></i></a>
                                </td>
                                <td>
                                    <a href="deletepayments.php?id=<?php echo $row['paymentid']?>" class="link-dark"><i class="fa-solid fa-trash"></i></a>
                                </td>
                                </tr>
                            <?php
                        }
