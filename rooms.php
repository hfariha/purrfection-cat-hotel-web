...
<body>
    ...
    <br><br>
    <h3 class="text-center m-auto mb-4" style="font-weight:600; font-size:45px">OUR BOARDING ROOMS</h3>
    <div class="container">
        <div class="row">
        ...
        <div class="input-group form-outline mb-4">
            <a href='fullbookform.php' id='booknow' class='btn btn-sm height-btn text-center bg-warning shadow-sm mb-2 w-100'> Book Now </a>
        </div>
